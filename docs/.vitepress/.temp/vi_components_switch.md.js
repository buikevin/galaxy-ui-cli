...
const __pageData = JSON.parse('{"title":"Switch","description":"","frontmatter":{},"headers":[],"relativePath":"vi/components/switch.md","filePath":"vi/components/switch.md","lastUpdated":1761927024000}');
const _sfc_main = { name: "vi/components/switch.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="switch" tabindex="-1">Switch <a class="header-anchor" href="#switch" aria-label="Permalink to &quot;Switch&quot;">​</a></h1><p>Công tắc bật/tắt.</p>`);
