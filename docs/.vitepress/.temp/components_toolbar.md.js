...
const __pageData = JSON.parse('{"title":"Toolbar","description":"","frontmatter":{},"headers":[],"relativePath":"components/toolbar.md","filePath":"components/toolbar.md","lastUpdated":1761927024000}');
const _sfc_main = { name: "components/toolbar.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/toolbar.md");
