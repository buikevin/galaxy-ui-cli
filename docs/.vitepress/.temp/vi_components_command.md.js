...
const __pageData = JSON.parse('{"title":"Command","description":"","frontmatter":{},"headers":[],"relativePath":"vi/components/command.md","filePath":"vi/components/command.md","lastUpdated":1761927024000}');
const _sfc_main = { name: "vi/components/command.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("vi/components/command.md");
