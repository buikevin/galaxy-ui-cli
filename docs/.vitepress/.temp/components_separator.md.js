...
const __pageData = JSON.parse('{"title":"Separator","description":"","frontmatter":{},"headers":[],"relativePath":"components/separator.md","filePath":"components/separator.md","lastUpdated":1761927024000}');
const _sfc_main = { name: "components/separator.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="separator" tabindex="-1">Separator <a class="header-anchor" href="#separator" aria-label="Permalink to &quot;Separator&quot;">​</a></h1><p>Visual separator line.</p>`);
