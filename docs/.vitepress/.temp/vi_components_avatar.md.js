...
const __pageData = JSON.parse('{"title":"Avatar","description":"","frontmatter":{},"headers":[],"relativePath":"vi/components/avatar.md","filePath":"vi/components/avatar.md","lastUpdated":1761927024000}');
const _sfc_main = { name: "vi/components/avatar.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="avatar" tabindex="-1">Avatar <a class="header-anchor" href="#avatar" aria-label="Permalink to &quot;Avatar&quot;">​</a></h1><p>Phần tử hình ảnh với fallback để đại diện cho người dùng.</p>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("vi/components/avatar.md");
