...
const __pageData = JSON.parse('{"title":"Tags Input","description":"","frontmatter":{},"headers":[],"relativePath":"components/tags-input.md","filePath":"components/tags-input.md","lastUpdated":1761927024000}');
const _sfc_main = { name: "components/tags-input.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/tags-input.md");
